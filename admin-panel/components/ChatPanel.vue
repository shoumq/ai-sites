...
<template>
  <div class="chat-panel">
    <p class="chat-panel__examples">
      ...
      «Добавь блок с отзывами перед ценами», «Сделай акцентный цвет бирюзовым».
    </p>

    <div ref="logEl" class="chat-panel__log">
      <div v-if="messages.length === 0" class="chat-panel__empty">
        <Icon name="lucide:message-circle" />
        <p>Понимаю свободные формулировки: переставить, добавить, удалить блок, поменять текст, цвет, вариант оформления.</p>
      </div>
